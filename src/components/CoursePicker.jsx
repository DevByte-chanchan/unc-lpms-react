/**
 * CoursePicker — single-select course picker sourced from the period's catalog
 * courses, grouped by SCIS year level with filter chips + search.
 *
 ...
 *
 * "Course Offerings" remains the label users see; the catalog (`courses`) is
 * what it reads, since course_offerings was dissolved into it.
 *
 * Props:
...
const CoursePicker = ({ value, onChange, courses = [], excludeCodes = [], placeholder = 'Search course code or title…', invalid = false }) => {
